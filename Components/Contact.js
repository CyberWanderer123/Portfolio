      ...
      <div>
        ...
        <div>
          <form action="https://getform.io/f/1808368a-9079-4da8-bf1a-e130bf6c045a" method="POST" className="flex flex-col bottom-2 border-indigo-200 w-full md:w-1/2 md:mx-80 px-4">
            ...
            <button className="text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 md:my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300">
              Submit
            </button>
          </form>
        </div>
